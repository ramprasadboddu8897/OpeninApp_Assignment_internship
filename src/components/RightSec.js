  ...
  return (
    <section className="right--section col-span-4 flex flex-col">
      <article className="top--section flex items-center justify-around w-full px-8 py-4">
        <span className="text-2xl text-left font-semi-bold mr-auto">
          Dashboard
        </span>
        <input
          type="text"
      ...
      <article className="summary w-full h-full px-8 py-8">
        ...
        <div className="histogram bg-white h-360px w-full row-span-2 rounded-2xl mt-4 pt-4">
          <ChartContainer />
        </div>
        <SummaryPie />
      </article>
